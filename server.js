...
var connectionString = 'mongodb://localhost/NextReadHuntDB';
...
var dbNextReadHunt = mongoose.connect(connectionString);
...
require("./public/assignment/server/app.js")(app, dbNextReadHunt, mongoose);
